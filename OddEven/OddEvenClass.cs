...
namespace OddEven
{
    ...
    {
        public string PrintOddEven(int startNumber, int lastNumber) => GetOddEvenWithinRange(startNumber, lastNumber);
        ...
        private bool IsEvenNumber(int number) => number >= 2 && number % 2 == 0;
